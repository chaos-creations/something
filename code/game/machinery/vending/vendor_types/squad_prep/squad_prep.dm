...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/upp/alt/populate_product_list(scale)
	listed_products = list(
		...
		list("Army fatigues", round(scale * 15), /obj/item/clothing/under/marine/veteran/upp/army/alt, VENDOR_ITEM_REGULAR),
		list("Army Jungle Fatigues", round(scale * 15), /obj/item/clothing/under/marine/veteran/upp/army, VENDOR_ITEM_REGULAR),
		list("Combat Gloves", round(scale * 15), /obj/item/clothing/gloves/marine, VENDOR_ITEM_REGULAR),
		list("Combat Glovesm, Brown", round(scale * 15), /obj/item/clothing/gloves/marine/brown, VENDOR_ITEM_REGULAR),
		list("Radio Headset", round(scale * 15), /obj/item/device/radio/headset/almayer/marine/solardevils/upp, VENDOR_ITEM_REGULAR),
		list("1PN77M \"Periskop\" Camera Unit", floor(scale * 15), /obj/item/device/overwatch_camera/upp, VENDOR_ITEM_REGULAR),
