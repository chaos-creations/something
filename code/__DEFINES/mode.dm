...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_GROM, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC))
...
GLOBAL_LIST_INIT(ROLES_AI_GROM, list(JOB_SQUAD_LEADER_GROM, JOB_SQUAD_TEAM_LEADER_GROM, JOB_SQUAD_MEDIC_GROM, JOB_SQUAD_SMARTGUN_GROM, JOB_SQUAD_ENGI_GROM, JOB_SQUAD_MARINE_GROM, JOB_SQUAD_RTO_GROM))
