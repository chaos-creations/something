...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_EXTRACTION, SQUAD_RAIDER, SQUAD_UNKNOWN))
...
GLOBAL_LIST_INIT(ROLES_PMCPLT_SMALL, list(JOB_PMCPLAT_SMALL_LEADER, JOB_PMCPLAT_SMALL_FTL, JOB_PMCPLAT_SMALL_SG, JOB_PMCPLAT_SMALL_STANDARD, JOB_PMCPLAT_SMALL_MEDIC))
GLOBAL_LIST_INIT(ROLES_RMCTROOP, list(JOB_TWE_RMC_LIEUTENANT, JOB_TWE_RMC_TROOPLEADER, JOB_TWE_RMC_SECTIONLEADER, JOB_TWE_RMC_TEAMLEADER, JOB_TWE_RMC_BREACHER, JOB_TWE_RMC_SMARTGUNNER, JOB_TWE_RMC_MARKSMAN, JOB_TWE_RMC_ENGI, JOB_TWE_RMC_MEDIC, JOB_TWE_RMC_RIFLEMAN))
GLOBAL_LIST_INIT(ROLES_AI_EXTRACTION, list(JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_MARINE, JOB_SYNTH))
GLOBAL_LIST_INIT(ROLES_AI_RAIDER, list(JOB_SO_RAIDER, JOB_SQUAD_LEADER_RAIDER, JOB_SQUAD_TEAM_LEADER_RAIDER, JOB_SQUAD_ENGINEER_RAIDER, JOB_SQUAD_MEDIC_RAIDER, JOB_SQUAD_MARINE_RAIDER))
GLOBAL_LIST_INIT(ROLES_AI_UNKNOWN, list(JOB_SQUAD_UNKNOWN_SURVIVOR))
...
#define FACTION_FIL "French Foreign Legion"
...
#define FACTION_SCAV "Scavenger"

#define FACTION_LIST_UA list(FACTION_MARINE, FACTION_ARMY, FACTION_NAVY)
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_FIL, FACTION_SCAV)
#define FACTION_LIST_ERT_OTHER list(FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO)
#define FACTION_LIST_ERT_ALL list(FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY, FACTION_CLF, FACTION_CONTRACTOR, FACTION_UPP, FACTION_FREELANCER, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_MARSHAL, FACTION_TWE, FACTION_FIL)
...
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_PMC, FACTION_WY)
#define FACTION_LIST_FIL list(FACTION_FIL)
...
#define FACTION_LIST_MALFUNCTION_SYNTH list(FACTION_MALF_SYNTH)
#define FACTION_LIST_SCAV list(FACTION_SCAV)
