...
/datum/skills/combat_medic/extraction
	name = "Deserter Medic"
	skills = list(
...
/datum/skills/smartgunner/extraction
	name = "Raider Smartgunner"
	skills = list(
		SKILL_JTAC = SKILL_JTAC_BEGINNER,
		SKILL_ENDURANCE = SKILL_ENDURANCE_MASTER,
		SKILL_SPEC_WEAPONS = SKILL_SPEC_ALL,
...
/datum/skills/tl/extraction
	name = "Deserter Fireteam Leader"
	skills = list(
		SKILL_SPEC_WEAPONS = SKILL_SPEC_ALL,
		SKILL_ENGINEER = SKILL_ENGINEER_ENGI,
		SKILL_CONSTRUCTION = SKILL_CONSTRUCTION_ENGI,
