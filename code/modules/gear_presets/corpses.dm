...
/datum/equipment_preset/corpse/forecon
...
/datum/equipment_preset/corpse/forecon/New()
	. = ..()
...
/datum/equipment_preset/corpse/forecon/proc/add_forecon_weapon(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/corpse/forecon/proc/spawn_random_headgear(mob/living/carbon/human/new_human)
	var/i = rand(1,10)
	switch(i)
		if (1 , 2)
...
/datum/equipment_preset/corpse/forecon/proc/spawn_random_tech_headgear(mob/living/carbon/human/new_human)
	var/i = rand(1,4)
	switch(i)
		if (1 , 2)
...
/datum/equipment_preset/corpse/forecon/proc/add_forecon_weapon_pistol(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/corpse/forecon/standard
...
/datum/equipment_preset/corpse/forecon/standard/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/corpse/forecon/tech
...
/datum/equipment_preset/corpse/forecon/tech/load_gear(mob/living/carbon/human/new_human)
	add_forecon_uniform(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/ranks/marine/e5(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/reagent_container/food/drinks/flask/marine(new_human), WEAR_IN_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/facepaint/sniper(new_human), WEAR_IN_ACCESSORY)
...
/datum/equipment_preset/corpse/forecon/marksman
...
/datum/equipment_preset/corpse/forecon/marksman/load_gear(mob/living/carbon/human/new_human)
	add_forecon_uniform(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/ranks/marine/e5(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/firstaid/full/alternate(new_human), WEAR_L_STORE)
...
/datum/equipment_preset/corpse/forecon/smartgunner
...
/datum/equipment_preset/corpse/forecon/smartgunner/load_gear(mob/living/carbon/human/new_human)
	add_forecon_uniform(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/ranks/marine/e5(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/firstaid/full/alternate(new_human), WEAR_L_STORE)
...
/datum/equipment_preset/corpse/forecon/squad_leader
...
/datum/equipment_preset/corpse/forecon/squad_leader/load_gear(mob/living/carbon/human/new_human)
	add_forecon_uniform(new_human)
