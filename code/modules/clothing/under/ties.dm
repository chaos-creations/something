...
/obj/item/clothing/accessory/patch/upp/grom
	name = "UPP Naval Reconnaissance patch"
	desc = "A fire-resistant shoulder patch, worn by the men and women of the UPP Naval Reconnaissance."
	icon_state = "grompatch"
