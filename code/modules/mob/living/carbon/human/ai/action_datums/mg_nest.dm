...
/datum/admins/proc/create_human_ai_machinegunner()
	...
	var/static/list/machinegunner_equipment_presets = list(
		...
		/datum/equipment_preset/scav/machinegun_light::name = /datum/equipment_preset/scav/machinegun_light,
		/datum/equipment_preset/scav/machinegun::name = /datum/equipment_preset/scav/machinegun,
	)
